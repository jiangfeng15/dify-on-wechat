...
available_setting = {
    ...
    "news_push_group_list": [],#开启后自动定时任务news,推送新闻早报
    "goods_push_group_list":[],#开启后自动定时任务goods_push,推送商品信息
    "goods_order_at_who":"锋", #商品购物订单详情@成员昵称
    "monitor_msg_group_list":"",#监控群消息的list
    "forward_msg_group_list":"",#需要转发群消息的list
    "only_group_welcome_list": [], #该列表表示群只处理成员进群欢迎语
}
